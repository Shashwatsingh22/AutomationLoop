...
class DetailWebC extends StatefulWidget {
  DetailWebC({Key key}) : super(key: key);

  @override
  _DetailWebCState createState() => _DetailWebCState();
}
...
final _portControler = TextEditingController();
final _foldControler = TextEditingController();
...
Execute(var list,var p, var f) async
{
  count++;
  var url="http://192.168.43.49/cgi-bin/back.py?medthod=CustomWeb&detail=$list&port=$p&foldName=$f";
  var response = await http.get(url);
  webdata=response.body;
}

class _DetailWebCState extends State<DetailWebC> {
  @override
                  ...
                  FlatButton(
                      ...
                      onPressed: ()
                      {
                       setState(() {
                           ...
                           port=_portControler.text;
                         _portControler.clear();
                         fold= _foldControler.text;
                         _foldControler.clear();
